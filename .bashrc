...
export PATH=/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/share/games:/usr/local/sbin:/usr/sbin:/sbin:~/local/bin:/snap/bin:~/Documents/Tools:~/Documents/Tools/Linux:~/Documents/Tools/Windows
